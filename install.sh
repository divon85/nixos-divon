...
sed -i "0,/divon/s//$(whoami)/" ~/.dotfiles/flake.nix
sed -i "0,/Divon/s//$(getent passwd $(whoami) | cut -d ':' -f 5 | cut -d ',' -f 1)/" ~/.dotfiles/flake.nix
sed -i "s/igornovid@outlook.com//" ~/.dotfiles/flake.nix
